...
The authors' original code is released under the GNU General Public License v3.0 only (see `LICENSE`). Please cite the accompanying article using `CITATION.cff`. Its PLOS Computational Biology citation is provisional until publication details and a DOI are available.
